...
import com.kafka.kafkaproducerconsumer.dto.KMessage;import java.util.HashMap;
...
public class KafkaConfiguration {
    @Value("${stutuncu.kafka.address}")
    private String kafkaAdress;

    @Value("${stutuncu.kafka.group.id}")
    ...
    public ProducerFactory producerFactory() {
        ...
        config.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, kafkaAdress);
